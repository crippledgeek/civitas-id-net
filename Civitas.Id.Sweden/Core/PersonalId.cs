    ...
    ISpanParsable<PersonalId>
{
    ...
    private PersonalId(string normalised)
    {
    ...
    /// <summary>
    ///     Formats the personnummer using <paramref name="timeProvider" /> to
    ...
    /// </param>
    /// <returns>The formatted personnummer string.</returns>
    /// <exception cref="ArgumentNullException">
    ///     Thrown when <paramref name="timeProvider" /> is <see langword="null" />.
    /// </exception>
    [Pure]
    ...
    /// <summary>
    ///     Formats this personnummer using <paramref name="today" /> as the
